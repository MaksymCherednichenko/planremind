...
import 'my_car_popup_model.dart';
export 'my_car_popup_model.dart';

class MyCarPopupWidget extends StatefulWidget {
  const MyCarPopupWidget({
    super.key,
    required this.car,
  });
  ...
  @override
  State<MyCarPopupWidget> createState() => _MyCarPopupWidgetState();
}

class _MyCarPopupWidgetState extends State<MyCarPopupWidget> {
  late MyCarPopupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyCarPopupModel());
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (confirmDialogResponse) {
                                      ...
                                      _model.deleteIndex = 0;
                                      while (_model.deleteIndex <
                                          _model.history!.length) {
                                        await _model.history!
                                            .elementAtOrNull(
                                                _model.deleteIndex)!
                                            .reference
                                            .delete();
                                        _model.deleteIndex =
                                            _model.deleteIndex + 1;
                                      }
                                      _model.taskList =
                                      ...
                                      _model.spareList =
                                          await queryCarSparePartsRecordOnce(
                                        parent: FFAppState().currentUserRef,
                                      ...
                                      _model.deleteIndex = 0;
                                      while (_model.deleteIndex <
                                          _model.spareList!.length) {
                                        await _model.spareList!
                                            .elementAtOrNull(
                                                _model.deleteIndex)!
                                            .reference
                                            .delete();
                                      ...
                                      await widget!.car!.reference.delete();
                                      Navigator.pop(context);
                                    }
