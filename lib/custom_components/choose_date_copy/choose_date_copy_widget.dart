...
import 'choose_date_copy_model.dart';
export 'choose_date_copy_model.dart';

class ChooseDateCopyWidget extends StatefulWidget {
  const ChooseDateCopyWidget({super.key});

  @override
  State<ChooseDateCopyWidget> createState() => _ChooseDateCopyWidgetState();
}

class _ChooseDateCopyWidgetState extends State<ChooseDateCopyWidget> {
  late ChooseDateCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChooseDateCopyModel());
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: Builder(
                                builder: (context) {
                                  final years = FFAppConstants.Years.toList();
                                  ...
                                  return SingleChildScrollView(
                                    child: Column(
                                      ...
                                      crossAxisAlignment:
                                          CrossAxisAlignment.center,
                                      children: List.generate(years.length,
                                          (yearsIndex) {
