...
class NewEventPopupWidget extends StatefulWidget {
  const NewEventPopupWidget({
    super.key,
    this.healthEvent,
    bool? isViewForm,
  }) : this.isViewForm = isViewForm ?? false;

  final HealthEventRecord? healthEvent;
  final bool isViewForm;
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget!.healthEvent != null) {
        if (widget!.isViewForm != null) {
          _model.isPublicForm = widget!.isViewForm;
          safeSetState(() {});
        }
        safeSetState(() {
        ...
        safeSetState(() {
          _model.nameTextFieldTextController?.text = widget!.healthEvent!.name;
        });
        safeSetState(() {
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if (widget!.healthEvent != null) {
                                          await widget!.healthEvent!.reference
                                              .update(
                                                  createHealthEventRecordData(
                                            name: _model
                                                .nameTextFieldTextController
                                                .text,
                                            description: _model
                                            ...
                                            dateOnly: functions.getDateOnly(
                                                _model.datePicked!),
                                          ));
                                        } else {
                                          var healthEventRecordReference =
                                              HealthEventRecord.createDoc(
                                                  FFAppState().currentUserRef!);
                                          await healthEventRecordReference
                                              .set(createHealthEventRecordData(
                                            name: _model
                                                .nameTextFieldTextController
                                                .text,
                                            description: _model
                                          ...
                                          _model.createdItemOutput =
                                              HealthEventRecord.getDocumentFromData(
                                                  createHealthEventRecordData(
                                                    name: _model
                                                        .nameTextFieldTextController
                                                        .text,
                                                  ...
                                                  healthEventRecordReference);
                                          if (functions.getDateOnly(
                                                  _model.datePicked!) <
                                              functions.getDateOnly(
                                                  getCurrentTimestamp)) {
                                            await HealthEventArchiveRecord
                                              ...
                                              date: functions.getDateOnly(
                                                  _model.datePicked!),
                                              eventReference: _model
                                                  .createdItemOutput?.reference,
                                            ));
                                          }
                                        }
                                  ...
                                  Padding(
                                    ...
                                    child: StreamBuilder<
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<HealthEventArchiveRecord>
                                            stackHealthEventArchiveRecordList =
                                            snapshot.data!;
                                        ...
                                        return Stack(
                                          alignment:
                                              AlignmentDirectional(0.0, 0.0),
                                          children: [
                                            if ((stackHealthEventArchiveRecord !=
                                                    null) ==
                                                false)
                                              Align(
                                                ...
                                                child: FFButtonWidget(
                                                  ...
                                                  text: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'wcrugdcf' /* Позначити як виконане */,
                                                  ),
                                                  icon: Icon(
                                                    Icons.done,
                                                    size: 28.0,
