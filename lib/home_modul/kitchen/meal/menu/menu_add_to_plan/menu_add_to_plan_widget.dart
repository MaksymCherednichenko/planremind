...
import 'menu_add_to_plan_model.dart';
export 'menu_add_to_plan_model.dart';

class MenuAddToPlanWidget extends StatefulWidget {
  const MenuAddToPlanWidget({
    super.key,
    required this.itemInMenu,
  });

  final DocumentReference? itemInMenu;

  @override
  State<MenuAddToPlanWidget> createState() => _MenuAddToPlanWidgetState();
}

class _MenuAddToPlanWidgetState extends State<MenuAddToPlanWidget> {
  late MenuAddToPlanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MenuAddToPlanModel());
      ...
      child: Scaffold(
            ...
            child: FFButtonWidget(
              onPressed: () async {
                if (_model.textController.text != null &&
                  ...
                  await widget!.itemInMenu!.delete();
                  context.safePop();
                }
              },
        ...
        body: SafeArea(
          ...
          child: StreamBuilder<MenuRecord>(
            stream: MenuRecord.getDocument(widget!.itemInMenu!),
                                  ...
                                  return GestureDetector(
                                    ...
                                    child: Padding(
                                      ...
                                      child: DeleteMealWidget(
                                        mealInMenuRef: widget!.itemInMenu,
                                      ),
                                    ),
                                  );
                                },
                        ...
                        children: [
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 0.0, 16.0),
                            child:
                                StreamBuilder<List<MenuItemIngredientsRecord>>(
                              stream: queryMenuItemIngredientsRecord(
                                parent: widget!.itemInMenu,
                                            ...
                                            return GestureDetector(
                                              ...
                                              child: Padding(
                                                padding:
                                                    MediaQuery.viewInsetsOf(
                                                        context),
                                                child: AddMenuToPlanPopupWidget(
                                                  itemMenu: columnMenuRecord,
                                                ),
                                              ),
                                            );
                                          },
